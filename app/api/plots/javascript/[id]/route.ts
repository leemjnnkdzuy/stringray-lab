...
export async function GET(req: Request, {params}: RouteParams) {
	try {
		...
		const plot = await PlotJavascript.findById(id);
		...
		console.error("Get JavaScript plot error:", error);
		return NextResponse.json(
...
export async function PATCH(req: Request, {params}: RouteParams) {
	try {
		...
		if (data.sourceCode !== undefined) plot.sourceCode = data.sourceCode;
		...
		console.error("Update JavaScript plot error:", error);
		return NextResponse.json(
...
export async function DELETE(req: Request, {params}: RouteParams) {
	try {
		...
		await PlotJavascript.findByIdAndDelete(id);
		...
		console.error("Delete JavaScript plot error:", error);
		return NextResponse.json(
