...
export async function GET(req: Request, {params}: RouteParams) {
	try {
		...
		const plot = await PlotMathLab.findById(id);
		...
		console.error("Get MATLAB plot error:", error);
		return NextResponse.json(
...
export async function PATCH(req: Request, {params}: RouteParams) {
	try {
		...
		console.error("Update MATLAB plot error:", error);
		return NextResponse.json(
...
export async function DELETE(req: Request, {params}: RouteParams) {
	try {
		...
		await PlotMathLab.findByIdAndDelete(id);
		...
		console.error("Delete MATLAB plot error:", error);
		return NextResponse.json(
